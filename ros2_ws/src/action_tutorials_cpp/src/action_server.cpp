...
void execute(
    const std::shared_ptr<GoalHandleFibonacci> goal_handle){
        ...
        if (rclcpp::ok()){
            ...
            RCLCPP_INFO(rclcpp::get_logger("server"), "Goal succed");
...
int main(int argc, char ** argv){
    ...
    auto action_server = rclcpp_action::create_server<Fibonacci>(node, "fibonacci", handle_goal, handle_cancel, handle_accepted);
